	...
	_createClass(Simple, [
		...
		},
		{
			...
			value: function cull(bounds, skipUpdate) {
				...
				try {
					for (
						var _iterator2 = this.lists[Symbol.iterator](), _step2;
						...
						try {
							for (
								var _iterator3 = list[Symbol.iterator](), _step3;
		...
		},
		{
			...
			value: function updateObjects() {
				if (this.dirtyTest) {
					...
					try {
						for (
							var _iterator4 = this.lists[Symbol.iterator](), _step4;
					...
					try {
						for (
							var _iterator6 = this.lists[Symbol.iterator](), _step6;
							...
							if (!_list.staticObject) {
								...
								try {
									for (
										var _iterator7 = _list[Symbol.iterator](), _step7;
		...
		},
		{
			...
			value: function updateObject(object) {
				...
				object[this.AABB].x =
					object.x + (box.x - object.pivot.x) * object.scale.x
				object[this.AABB].y =
					object.y + (box.y - object.pivot.y) * object.scale.y
		...
		},
		{
			...
			value: function query(bounds) {
				...
				try {
					for (
						var _iterator8 = this.lists[Symbol.iterator](), _step8;
		...
		},
		{
			...
			value: function queryCallback(bounds, callback) {
				...
				try {
					for (
						var _iterator10 = this.lists[Symbol.iterator](), _step10;
		...
		},
		{
			...
			value: function stats() {
				...
				try {
					for (
						var _iterator12 = this.lists[Symbol.iterator](), _step12;
